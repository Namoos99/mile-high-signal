...
def main(argv: list[str] | None = None) -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="denver311_raw_") as raw_tmp:
        ...
        try:
            ...
            # --- write Parquet locally, then push to S3's processed/ zone -------
            with tempfile.TemporaryDirectory(prefix="denver311_out_") as out_tmp:
                ...
                preview_csv = preview_dir / "service_requests_preview.csv"
            ...
            summary = {
                ...
                "invalid_coordinates": clean_df.where(
                    "~has_valid_coordinates AND Latitude IS NOT NULL"
                ).count(),
            }
